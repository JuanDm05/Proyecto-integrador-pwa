export const environment = {
  ...
  // Tus valores REALES de Firebase aqu�:
  firebaseConfig: {
  ...
  // Tu API Key de Gemini para desarrollo (usa placeholder si quieres subir a GitHub)
geminiApiKey: "AIzaSyDRoCA-gmXadwvtSudpKy08WBYBI7vDaZk"
};
